...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_HYPR_WIN] = LAYOUT(
        ...
        DM_REC1, KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_TRNS,                   KC_PSCR, KC_BRMD, KC_BRMU, KC_TRNS, KC_TRNS, KC_TRNS,
    ...
    [_HYPR_MAC] = LAYOUT(
        KC_CAPS, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_TRNS,                   QK_MAKE, KC_TRNS, KC_TRNS, KVM_MA1, KVM_MA2, KVM_MA3,
        DM_REC2, KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_TRNS,                   KC_PSCR, KC_BRMD, KC_BRMU, KC_TRNS, KC_TRNS, KC_TRNS,
