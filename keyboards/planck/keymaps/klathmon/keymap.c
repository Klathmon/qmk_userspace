...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAIN_WIN] = LAYOUT_planck_grid(
        ...
        KC_NO,   KC_NO,   M_HESCW, M_LALTE, KC_LCTL, KC_SPC,  M_NUMRD, M_MVMTW, M_NUMP,  M_HESCW, KC_NO,   KC_ENT
    ),
    ...
    [_MAIN_MAC] = LAYOUT_planck_grid(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,
        KC_NO,   KC_NO,   M_HESCM, M_LALTE, KC_LGUI, KC_SPC,  M_NUMRD, M_MVMTM, M_NUMP, M_HESCM,  KC_NO,   KC_ENT
    ),
    ...
    [_HYPR_WIN] = LAYOUT_planck_grid(
        ...
        M_SSHTW, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, M_SLEPW, QK_BOOT, KQ_FLSH, KC_MPRV, KC_MPLY, KC_MNXT, M_TGLM
    ),
    [_HYPR_MAC] = LAYOUT_planck_grid(
        ...
        M_SSHTM, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, M_SLEPM, QK_BOOT, KQ_FLSH, KC_MPRV, KC_MPLY, KC_MNXT, M_TGLM
    )
};
// clang-format on
