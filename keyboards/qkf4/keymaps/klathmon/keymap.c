...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_HYPR_WIN] = LAYOUT(
        KC_CAPS, DM_REC1, KC_F1,   KC_F2,   KC_F3,   KC_F4,            KC_TRNS, KC_PSCR, KVM_KBM, KVM_MA1, KVM_MA2, KVM_MA3,
        DM_PLY1, KC_TRNS, KC_F5,   KC_F6,   KC_F7,   KC_F8,            M_LOCKW, KC_VOLD, KC_MUTE, KC_VOLU, KC_WBAK, KC_WFWD,
    ...
    [_HYPR_MAC] = LAYOUT(
        KC_CAPS, DM_REC2, KC_F1,   KC_F2,   KC_F3,   KC_F4,            KC_TRNS, KC_PSCR, KVM_KBM, KVM_MA1, KVM_MA2, KVM_MA3,
        DM_PLY2, KC_TRNS, KC_F5,   KC_F6,   KC_F7,   KC_F8,            M_LOCKM, KC_VOLD, KC_MUTE, KC_VOLU, M_BAKM,  M_FWDM,
