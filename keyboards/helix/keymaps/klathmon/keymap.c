...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MAIN_WIN] = LAYOUT(
        ...
        KC_TRNS, KC_TRNS, M_HESCW, M_LALTE, KC_LCTL, KC_SPC,  KC_TRNS, KC_TRNS, KC_DEL,  M_MVMTW, M_NUMP,  M_HESCW, KC_TRNS, KC_TRNS
    ),
    //                                                         |                                                       //
    [_MVMT_WIN] = LAYOUT(
    ...
    [_MAIN_MAC] = LAYOUT(
        ...
        KC_TRNS, KC_TRNS, M_HESCM, M_LALTE, KC_LGUI, KC_SPC,  KC_TRNS, KC_TRNS, KC_DEL,  M_MVMTM, M_NUMP,  M_HESCM, KC_TRNS, KC_TRNS
    ),
    //                                                         |                                                       //
    [_MVMT_MAC] = LAYOUT(
    ...
    [_HYPR_WIN] = LAYOUT(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, M_SLEPW, M_SLEPW, KC_MPRV, KC_MPLY, KC_MNXT, KC_TRNS, M_TGLM,
    ...
    [_HYPR_MAC] = LAYOUT(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, M_SLEPM, M_SLEPW, KC_MPRV, KC_MPLY, KC_MNXT, KC_TRNS, M_TGLM,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, QK_RBT,  KC_TRNS, KC_TRNS, QK_BOOT, KQ_FLSH, KC_TRNS, KC_TRNS, KC_TRNS, M_TGLM
    )
};
// clang-format on
