...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MAIN_WIN] = LAYOUT(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, M_HESCW, M_LALTE, KC_LCTL, KC_SPC,  KC_DEL,  M_MVMTW, M_NUMP,  M_HESCW, KC_TRNS, KC_TRNS, KC_TRNS
    ),
    //                                                         |                                                       //
    [_MVMT_WIN] = LAYOUT(
    ...
    [_MAIN_MAC] = LAYOUT(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, M_HESCM, M_LALTE, KC_LGUI, KC_SPC,  KC_DEL,  M_MVMTM, M_NUMP,  M_HESCM, KC_TRNS, KC_TRNS, KC_TRNS
    ),
    //                                                         |                                                       //
    [_MVMT_MAC] = LAYOUT(
    ...
    [_HYPR_WIN] = LAYOUT(
        ...
        DM_PLY1, KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_TRNS,                   M_LOCKW, KC_VOLD, KC_MUTE, KC_VOLU, KC_WBAK, KC_WFWD,
        M_SSHTW, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, M_SLEPW, M_SLEPW, KC_MPRV, KC_MPLY, KC_MNXT, KC_TRNS, M_TGLM,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, QK_RBT,  KC_TRNS, KC_TRNS, QK_BOOT, KQ_FLSH, KC_TRNS, KC_TRNS, KC_TRNS, M_TGLM
    ),
    [_HYPR_MAC] = LAYOUT(
        KC_CAPS, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_TRNS,                   QK_MAKE, KC_BRMU, KVM_MA4, KVM_MA1, KVM_MA2, KVM_MA3,
        DM_REC2, KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_TRNS,                   KC_PSCR, KC_BRMD, KVM_KBM, KVM_SCB, KVM_SCC, KVM_SCA,
        DM_PLY2, KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_TRNS,                   M_LOCKM, KC_VOLD, KC_MUTE, KC_VOLU, M_BAKM,  M_FWDM,
        M_SSHTM, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, M_SLEPM, M_SLEPM, KC_MPRV, KC_MPLY, KC_MNXT, KC_TRNS, M_TGLM,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, QK_RBT,  KC_TRNS, KC_TRNS, QK_BOOT, KQ_FLSH, KC_TRNS, KC_TRNS, KC_TRNS, M_TGLM
    )
};
// clang-format on
