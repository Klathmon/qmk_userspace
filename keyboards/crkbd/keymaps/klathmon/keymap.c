...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_HYPR_WIN] = LAYOUT_split_3x6_3_ex2(
        DM_REC1, KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_TRNS, KC_TRNS,KC_TRNS, KC_TRNS, KC_PSCR, KVM_KBM, KVM_MA1, KVM_MA2, KVM_MA3,
        DM_PLY1, KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_TRNS, KC_TRNS,M_SLEPW, M_SLEPW, KC_VOLD, KC_MUTE, KC_VOLU, KC_WBAK, KC_WFWD,
    ...
    [_HYPR_MAC] = LAYOUT_split_3x6_3_ex2(
        DM_REC2, KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_TRNS, KC_TRNS,KC_TRNS, KC_TRNS, KC_PSCR, KVM_KBM, KVM_MA1, KVM_MA2, KVM_MA3,
        DM_PLY2, KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_TRNS, KC_TRNS,M_SLEPM, M_SLEPM, KC_VOLD, KC_MUTE, KC_VOLU, M_BAKM,  M_FWDM,
